    ...
    <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
        <div class="wrap-login100 p-l-100 p-r-100 p-t-62 p-b-33">
            <div class="login100-form validate-form flex pos-rel" style="justify-content: space-between; flex-wrap: wrap;">
                ...
                {{-- <img id="teacher_img" class="pos-a cur-p" src="/image/teacher_PNG.png" alt="Teacher" style="width: 100px; top: 60px; left: 0px; z-index: 9;">
                <span id="teacher_login_btn" class="cur-p btn-face m-b-20">
                    <span id="teacher_btn_text" class="p-l-20">Teacher</span>
                </span>

                <img id="student_img" class="pos-a cur-p" src="/image/student_login.png" alt="Student" style="width: 100px; top: 40px; z-index: 9; right: 5px;">
                <span id="student_login_btn" class="cur-p btn-google m-b-20">
                    <span id="student_btn_text" class="p-r-15">Student</span>
                </span> --}}
                ...
                <form id="teacher_login_form" class="w-full" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" name="email" required value="{{old('email')}}">
                    ...
                    {{-- <a href="{{ route('password.request') }}" class="txt2 bo1"> Forget Password </a> </div> --}}
                </form>
