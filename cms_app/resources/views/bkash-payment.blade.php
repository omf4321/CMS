                    ...
                    <form action="{{ route('bkash.get.token') }}" method="POST">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-condensed">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="white-space: normal;">Basic Coaching Management Web Application ({{$invoice->date_from}} - {{$invoice->date_to}})</td>
                        ...
                        <div class="container-fluid">
                            ...
                            <div id="trxid_input_div" style="display: none; margin-top: 10px;">
                                <div class="m-b-10" style="color: red">Make a payment to 01326599338. Then input the trxID to the following box.</div>
                        ...
                        <input style="display: none;" name="product_type" value="software">
                        <button id="bKash_button" style="margin: 20px auto; display: flex;">
                            PROCEED
                        </button>
                    </form>
                    <p class="text-center hidden-print" style="padding-bottom: 20px; font-size: 14px;"><a href="/admin/home/billing_invoice">Back to Invoice List</a></a></p>
                </div>
            </div>
            <div class="col-md-2"></div>
        </div>
