                ...
                <div>
                    <v-toolbar rounded color="indigo lighten-1" dark elevation="2" class="m-b-20 p-t-15 custom-toolbar">
                        <v-layout row wrap>
                            ...
                            <v-col cols="6" md="4" sm="4" class="pa-2">
                    ...
                    <v-dialog v-model="dialog" width="850" persistent transition="dialog-bottom-transition" scrollable>
                        <!-- @add_item_button -->
                        <v-card>
                            <v-card tile>
                                ...
                                <v-card-text class="grey lighten-5 pa-5 pt-5" style="height: 100%;">
                                    <!-- @add_item_field -->
                                    <template>
                                        <v-container grid-list-lg>
                                            <v-layout row justify-left>
                                                <v-form ref="form" v-model="valid" lazy-validation>
                                                    ...
                                                    <v-row class="m-b-10">
                                                        <v-col cols="9">
                                                            <v-row dense>
                                                                <v-col cols="6" sm="4">
                                                                    <template>
                                                                        <DatePicker :writable="true" v-model="dialogItem.date_of_admit" label="Admission Date"></DatePicker>
                                                                    </template>
                                                                </v-col>
                                                                <v-col cols="6" sm="4">
                                                                    <v-select outlined dense hide-details v-model="dialogItem.echelon_id" :disabled="editedIndex>-1" :items="echelon" label="Class" hide-details @change="get_batch"></v-select>
                                                                </v-col>
                                                            </v-row>
                                                            ...
                                                            <v-row dense>
                                                                ...
                                                                <v-col cols="6" sm="4" style="position:relative">
                                                                    ...
                                                                    <span class="reg_icon m-t-5 pos-a" style="top: 10px; right: 10px" v-if="editedIndex==-1">
                                                    ...
                                                    <div v-for="section in student_admission_fields" :key="section.title" class="mb-6">
                                                    <h4 class="m-b-5 font-bold text-lg" style="color: #31708f">{{ section.title }}</h4>
                                                    <hr class="m-t-0 m-b-15" style="border-color: #31708f;">
                                                    <v-row dense>
                                                        
                                                        <template v-if="section.subsections && section.subsections.length">
                                                            <template v-for="(subsection, sIndex) in section.subsections">
                                                                <h5 style="width: 100%; color: #333">{{ subsection.title }}</h5>
                                                                <v-row dense>
                                                                    <v-col
                                                                    v-for="(field, fIndex) in subsection.fields"
                                                                    :key="'field-'+fIndex"
                                                                    :cols="field.colSize || 4"
                                                                    >
                                                                    <component
                                                                        :is="getComponent(field.type)"
                                                                        v-model="dialogItem[field.name]"
                                                                        :label="field.label"
                                                                        :items="field.options || field.source || []"
                                                        ...
                                                        <template v-if="section.fields && section.fields.length">
                                                            <hr v-if="section.subsections && section.subsections.length" style="width: 100%; border-color: #31708f;">
                                                            <v-row dense>
                                                            <v-col
...
<script>
    ...
    import DatePicker from '../../../components/admin/helper/datePicker.vue';
            ...
            methods: {
                ...
                getComponent(type) {
                    switch (type) {
                        ...
                        case 'autocomplete': return 'v-autocomplete';
                        case 'date': return 'DatePicker'; // or custom date picker
                ...
                initialize_form() {
                    this.axios.get('/admin/request/initialize-form').then(response => {
                        this.student_admission_fields = response.data.admission_fields
                    });
                },
                admin_echelon_list() {
